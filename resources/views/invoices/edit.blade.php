            ...
            <div class="row g-3 mb-4 border-bottom pb-4">
                ...
                <div class="col-md-4">
                    ...
                    <select name="payment_mode" class="form-select bg-light border-0">
                        ...
                        <option value="Bank Remittance" {{ old('payment_mode', $invoice->payment_mode) == 'Bank Remittance' ? 'selected' : '' }}>Bank Remittance</option>
                    ...
                    <div class="card bg-light border-0">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <input type="number" step="0.01" name="paid_amount" id="paid_amount" class="form-control form-control-sm bg-white border-1 text-end fw-medium" style="width: 100px;" value="{{ old('paid_amount', number_format($invoice->paid_amount ?? 0, 2, '.', '')) }}">
                            </div>
