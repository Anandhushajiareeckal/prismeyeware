            ...
            <div class="card-body p-4">
                ...
                <div class="mb-2">
                    @if(($customer->category ?? 'Customer') === 'Shop')
                        <span class="badge bg-secondary-subtle text-secondary border border-secondary-subtle px-2 py-1 rounded-pill small">Shop</span>
                    @else
                        <span class="badge bg-primary-subtle text-primary border border-primary-subtle px-2 py-1 rounded-pill small">Customer</span>
                    @endif
                </div>
