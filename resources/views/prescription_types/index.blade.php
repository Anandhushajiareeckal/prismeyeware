...
@section('content')
<div class="mb-4">
    <h3 class="page-title mt-2 mb-0">Prescription Types Configuration</h3>
</div>
...
<div class="row">
    <div class="col-md-5">
        <div class="card shadow-sm border-0 mb-4 mb-md-0">
            <div class="card-header bg-white border-bottom pb-3 pt-4">
                <h5 class="mb-0 fw-semibold text-primary">Add New Prescription Type</h5>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('prescription-types.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label text-muted fw-medium">Prescription Type Name <span class="text-danger">*</span></label>
                        <input type="text" name="name" class="form-control bg-light border-0" placeholder="e.g., Bifocal" required>
                    </div>
                    <div class="mb-3">
    ...
    <div class="col-md-7">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white border-bottom pb-3 pt-4">
                <h5 class="mb-0 fw-semibold text-primary">Managed Prescription Types</h5>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            @forelse($prescriptionTypes as $type)
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <form action="{{ route('prescription-types.destroy', $type) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this prescription type?');">
                                        @csrf
                                        @method('DELETE')
                            ...
                            @empty
                            <tr>
                                <td colspan="3" class="text-center text-muted py-5">No prescription types configured yet.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
